...
export async function getSettingsList(address: string | null, ids: number[] | null): Promise<Settings[]> {
...
function formatAdventurer(data: any): Adventurer {
...
function formatBag(data: any): Item[] {
  let bag: Item[] = [];
